...
<body >
	...
	<form mane="Presidente" action="manejadorPresidente.php?accion=save" method="post" id="registro">
		<table>
		<tr>
			<td width="120"><font size="3">Nombres:</font></td>
			<td><input type="tex" name="nombre" class="required form-control" style="width:180" title="Ingrese los Nombres" required autocomplete="on"></td>
		</tr>
		<tr>
			<td width="120"><font size="3">Apellidos:</font></td>
			<td><input type="tex" name="apellido" class="required form-control" style="width:180" title="Ingrese los Apellidos" required autocomplete="on"></td>
		</tr>
		<tr>
			<td width="120"><font size="3">N° de DUI:</font></td>
			<td><input type="text" name="dui" class="required form-control" onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);" onkeydown="return validarNumeros(event)"  maxlength="10" title="Ingrese el Numero de DUI" style="width:180" required autocomplete="on" placeholder="00000000-0"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><select name="candidatura" class="required form-control" title="Selecione una de estas dos opciones" required autocomplete="on">
		...
		<tr>
			...
			<td><select style="width:180" name="partido" class="required form-control" style="width:180" title="Selecionar Partido" required autocomplete="on" id="depto">
				<option value="">Seleccionar...</option>
				<?php
