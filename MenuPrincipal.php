...
<div id="textoT0" class="auto-style4" style="left: 36px; top: 37px; height: 15%; width: 67%">
	...
	<tr>
		<td><a href="aperturaEleccion.php">Apertura de Nueva Elección</a><br><br></td>
	</tr>
	<tr>
		<td><a href="EstadosResultados.php">Resultados de Elecciones</a><br><br></td>
	</tr><br>
	<a href="MenuPrincipal.php" title="Ir a menú principal"><img src="css/sistema.JPG" width="600" height="250"></a>
	</div>
