...
<html>
    <head>
        ...
        <title>Resultados Diputados</title>
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            type: 'pie',
            name: 'Resultados de Asamblea Legislativa',
            data: [
...
<center>
<p><a href="../EstadosResultados.php">Menú de Resultados</a></p>
</center>
    </body>
</html>