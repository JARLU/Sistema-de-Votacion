...
<body >
	...
	<form action="modificarVotante.php" name="Registro Votante" method="post" id="registro" class="pager">
		<table>
		<tr>
			<td><input type="hidden" name="id" 
                    value='<?php print $datos[0][0]?>'></td>
		</tr>
		<tr>
			<td width="120"><font size="3">DUI:</font></td>
			<td><input type="text" name="dui" class="required form-control"  maxlength="10" placeholder="00000000-0" onkeyup="mascara(this,'-',patron3,true)" style="width:300px;" onkeypress="return justNumbers(event);"  title="Ingrese N° de DUI" required autocomplete="on" onkeydown="return validarNumeros(event)" value='<?php print $datos[0][1]?>'></td>
		</tr>
		<tr>
			<td width="120"><font size="3">Nombres:</font></td>
			<td><input type="text" name="nombre" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false" placeholder="Ingrese Sus Nombres" style="width:180" title="Ingrese los Nombres" required autocomplete="on" value='<?php print $datos[0][2]?>'></td>
		</tr>
		<tr>
			<td width="120"><font size="3">Apellidos:</font></td>
			<td><input type="text" name="apellido" class="required form-control" onkeydown="return validarLetras(event)" placeholder="Ingrese Sus Apellidos" style="width:180" title="Ingrese los Nombres" required autocomplete="on" value='<?php print $datos[0][3]?>'></td>
		</tr>
		<tr>
			<td width="120"><font size="3">Foto:</font></td>
			<td><input type="File" name="foto" required="true" value='<?php print $datos[0][4]?>'></td>
		</tr>
		<tr>
			...
			<td>
				<div class="col-xs-5">
                   <div class="input-group">                   
                    <input type="text" name="fechavenci" id="fechac" class="required form-control">
		...
		<tr>
			...
			<td><textarea name="direccion" minlength="2" placeholder="Ingrese Su Dirección" class="required form-control" minlength="2" required autocomplete="on" onkeydown="return validarLetras(event)" value='<?php print $datos[0][7]?>'></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td><center><input type="submit" name="bot" value="Guardar Cambios" class="google" title="Clic Para Registrar"></center></td>
