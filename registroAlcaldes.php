...
<body >
	...
	<center>
	<table>
	<h1>Inscripción de Alcaldes</h1>
	<form action="manejadorAlcalde.php?accion=save" method="post" id="registro" class="pager">
		<table>
    <table>
    <tr>
      <td width="120">Nombres:</td>
      <td><input type="text" name="nombre" placeholder="Ingresar Nombres" class="required form-control" style="width:180" title="Ingrese los Nombres" required autocomplete="on"></td>
    </tr>
    <tr>
      <td width="120">Apellidos:</td>
      <td><input type="text" name="apellido" placeholder="Ingresar Apellidos" class="required form-control" style="width:180" title="Ingrese los Apellidos" required autocomplete="on"></td>
    </tr>
    <tr>
      <td width="120">N° de DUI:</td>
      <td><input type="text" name="dui" onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);" title="Ingrese el Numero de DUI" class="required form-control" onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);" onkeydown="return validarNumeros(event)" maxlength="10" style="width:180" required autocomplete="on" placeholder="00000000-0"></td>
		<tr>
			<td width="120">Genero:</td>
			<td>Masculino<input type="radio" name="genero" value="Masculino" title="Seleccionar si es Hombre" required autocomplete="on">
				  Femenino<input type="radio" name="genero" value="Femenino" title="Seleccionar si es Mujer">
			</td>
		</tr>
		<tr>
			<td width="120">Dirección:</td>
			<td><textarea name="direccion" placeholder="Ingrese Su Dirección" style="width:180" class="required form-control" minlength="2" required autocomplete="on" onkeydown="return validarLetras(event)"></textarea></td>
		</tr>
    <tr>
      <td>Partido:</td>
      <td><select name="partido" style="width:180" title="Selecionar Partido" required autocomplete="on" class="required form-control">
